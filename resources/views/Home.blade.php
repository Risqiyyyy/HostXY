...
<body>
    <main class="min-h-screen bg-background px-14 text-white">
        ...
        <!-- product logo  -->
        <section class="flex justify-between mt-32">
            <img src="images/landingPage/logo_product/softaculous.svg" alt="softaculous logo">
            <img src="images/landingPage/logo_product/wordpress.svg" alt="wordpress logo">
            <img src="images/landingPage/logo_product/cloudflare.svg" alt="cloudflare logo">
            <img src="images/landingPage/logo_product/cpanel.svg" alt="cpanel logo">
            <img src="images/landingPage/logo_product/imunify.svg" alt="imunify logo">
            <img src="images/landingPage/logo_product/litespeed.svg" alt="litespeed logo">
        </section>
        <!-- product logo END -->

        <!-- why us -->
        <section class="mt-20 px-14 flex justify-between">
            <div class="w-[250px] flex flex-col text-center items-center">
                <img src="images/landingPage/logo/timer.svg" alt="" class="w-20 mb-3">
                <h1 class="text-xl font-bold">99.9% Uptime</h1>
                <p class="text-xs mt-1">We Keep Your Web build Online 24x7x365. Downtime not only costs you lost visitors but also damages your reputation and search engine rankings.</p>
            </div>
            <div class="w-[250px] flex flex-col text-center items-center">
                <img src="images/landingPage/logo/cloud.svg" alt="" class="w-20 mb-3">
                <h1 class="text-xl font-bold">Blazing Fast Web Hosting</h1>
                <p class="text-xs mt-1">We Keep Your Web build Online 24x7x365. Downtime not only costs you lost visitors but also damages your reputation and search engine rankings.</p>
            </div>
            <div class="w-[250px] flex flex-col text-center items-center">
                <img src="images/landingPage/logo/logo_ssl.svg" alt="" class="w-20 mb-3">
                <h1 class="text-xl font-bold">Free SSL Certificates</h1>
                <p class="text-xs mt-1">We Keep Your Web build Online 24x7x365. Downtime not only costs you lost visitors but also damages your reputation and search engine rankings.</p>
            </div>
            <div class="w-[250px] flex flex-col text-center items-center">
                <img src="images/landingPage/logo/cs_logo.svg" alt="" class="w-20 mb-3">
        ...
        <!-- Hosting Plan -->
        <section class="flex flex-col justify-center items-center mt-28">
            <h1 class="text-3xl font-semibold text-primary bg-secondary bg-opacity-[15%] pb-2 px-6 rounded-full">Hosting plan</h1>
            <p class="text-2xl text-center mt-10">Choose The Perfect Web Hosting <br> Package For You</p>
            <div class="flex mt-14">
                <div class="flex items-center mx-3">
                    <p class="text-2xl mr-8">Monthly</p>
                    <input type="checkbox" class="toggle toggle-secondary" checked />
                </div>
                <div class="flex items-center mx-3">
                    <p class="text-2xl mr-6">Yearly</p>
                    <p class="bg-[#FFE87A] text-sm py-2 px-4 rounded-lg">20% discount</p>
                </div>
            </div>
            <div class="flex mt-20">
                <p class="text-3xl font-semibold px-44 border-b-8 border-primary">Basic</p>
                <p class="text-3xl font-semibold px-44 border-b-8">Premium</p>
            </div>
        </section>
        <!-- Card -->
        <div class="flex justify-center items-center px-36 mt-14">
            <div class="w-64 text-black bg-white p-6 pb-10 rounded-xl">
                <div>
